...
public class NumberGuess2
{
    ...
    public void Run()
    {
        ...
        int correctNumbers = randomNumber.Next(1, 11);
        ...
        while (true) // denne får det som er under her til å kjøre hele tiden
        {
            ...
            // Start(num);
            guessNumber(input, correctNumbers, attempts); // disse para sender til guessnumber func
        }
    }

    public void guessNumber(string input, int correctNumbers, int attempts) // denne tar imot fra run()
    {
